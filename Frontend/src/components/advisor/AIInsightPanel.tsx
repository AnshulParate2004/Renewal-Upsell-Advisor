  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-6 pb-4 border-b border-border">
        ...
        <div>
          <h3 className="text-base font-bold text-foreground">Strategic Analysis</h3>
          <p className="text-[10px] text-muted-foreground uppercase tracking-wider font-bold">GENERATED BY REVIQ INTELLIGENCE</p>
        </div>
      </div>
