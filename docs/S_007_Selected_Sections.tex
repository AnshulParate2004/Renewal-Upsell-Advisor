...
\textbf{Strengths:}
\begin{itemize}
    \item End-to-end channel automation focused on vendors, distributors, and resellers
    \item Native capabilities for recurring revenue automation (Renewal Cloud), upsell/cross-sell (XSUS Cloud), and multi-vendor CPQ
    \item Strong support for multi-vendor installed-base data and channel hierarchies
    \item Open and unified APIs for integrating multiple vendor systems into a single channel platform
\end{itemize}

\textbf{Weaknesses:}
\begin{itemize}
    \item Primarily optimized for channel/partner-led sales motions rather than direct-only SaaS customer success
    \item Advanced CS-focused features (e.g., deep NPS-driven health scoring) may require custom extensions compared to dedicated CS platforms
\end{itemize}

\textbf{Technical Approach:} Yagna iQ provides a multi-tenant channel ecosystem platform that connects vendors, distributors, resellers, and end customers. It focuses on automating renewals, CPQ flows, upsell/cross-sell journeys, and lead distribution by ingesting multi-vendor historical transactions and installed-base data and exposing automation via shared cloud services and APIs.
...
\begin{longtable}{|p{2.6cm}|p{1.8cm}|p{2.0cm}|p{2.0cm}|p{2.0cm}|p{2.0cm}|p{2.5cm}|}
\hline
\textbf{Feature} & \textbf{Our Agent} & \textbf{Gainsight} & \textbf{ChurnZero} & \textbf{Totango} & \textbf{Catalyst} & \textbf{Yagna iQ} \\
\hline
Churn Prediction & Yes (ML) & Yes (ML) & Yes (ML) & Yes (Basic) & Yes (ML) & Indirect (via renewal analytics) \\
\hline
Upsell Propensity & Yes (ML) & Partial & Yes & Limited & Yes & Yes (XSUS Cloud) \\
\hline
Automated Playbooks & 15+ & 20+ & 10+ & 8+ & 5+ & Journey / play flows per module \\
\hline
Real-Time Alerts & Yes & Limited & Yes & No & Yes & Yes (channel workflows) \\
\hline
Sentiment Analysis & Yes (NLP) & Yes & Yes & No & Partial & Limited (requires integration) \\
\hline
Salesforce Native Sync & Bidirectional & Native Sync & Sync & Sync & Native Sync & Via open APIs / integrations \\
\hline
Stripe/Billing Integration & Yes & Yes & Limited & Yes & Yes & Via platform / billing connectors \\
\hline
Deployment Time & 7 days & 8--12 weeks & 4--6 weeks & 2--4 weeks & 3--5 weeks & 4--8 weeks (channel programs) \\
\hline
Pricing (Est.) & \$25K/yr & \$50K+/yr & \$30K/yr & \$20K/yr & \$35K/yr & Program-based (varies) \\
\hline
ML Model Accuracy & 85\%+ & 82\% & 78\% & 70\% & 80\% & Not publicly disclosed \\
\hline
\end{longtable}
\normalsize
